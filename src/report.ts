...
<body>
  ...
  <div class="parameters-section">
    ...
    <div class="param-row">
      ...
      <div class="param-desc" style="margin-top:12px">The truth is probably somewhere in between. The slider above blends the two models using a geometric mean.</div>
    </div>
    <div class="param-row">
