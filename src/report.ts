...
<body>
  ...
  <div class="parameters-section">
    <h2>Parameters</h2>
    <div class="param-row">
      <div class="param-name">Cost Model</div>
      ...
      <div class="param-desc" style="margin-top:12px">The truth is somewhere in between. The slider above blends the two models using a geometric mean.</div>
    </div>
    <div class="param-row">
  ...
  <table id="dataTable">
    <thead>
      <tr>
        ...
        <th data-key="matchRate" data-type="number" class="right">% Faculty Teaching <span class="sort-arrow">▾</span></th>
        ...
        <th data-key="computed_teaching_pct" data-type="number" class="right">% Teaching Spend <span class="sort-arrow">▾</span></th>
      </tr>
    </thead>
    <tbody></tbody>
  </table>
  ...
  <div class="methodology">
    ...
    <ol style="line-height:1.7;margin-bottom:12px;margin-left:20px">
      ...
      <li><strong>Metrics.</strong> The department&rsquo;s total teaching spend (summed across all matched faculty) is divided by either total unique students (Divided cost model) or total courses (Shared cost model), or a blend of both.</li>
    </ol>
    <p style="line-height:1.7;margin-bottom:12px">
  ...
  <script>
    ...
    const AXIS_OPTIONS = [
      ...
      { key: 'computedTeachingPct', label: '% Teaching Spend', get: r => computeTeachingPct(r), fmt: fmtPct },
